...
class TicketInfoForm extends React.Component {
    constructor(props) {
        ...
        this.isEmailFieldReadOnly = this.isEmailFieldReadOnly.bind(this);
    }
    ...
    getTicketEmail(ticketIdx, order, firstTicket, tix , ticketType){
        ...
        if(ticketType.audience  === 'WithInvitation' && ticketIdx === 0 )
    ...
    isEmailFieldReadOnly(ticketIdx, order, firstTicket, tix , ticketType){
        if(ticketType.audience  === 'WithInvitation' && ticketIdx === 0)
            return true;
        return false;
    }
                              ...
                              <div className="row-ticket">
                                ...
                                <div className="col-md-6">
                                  <Input
                                      ...
                                      readOnly={this.isEmailFieldReadOnly(i, order, firstTicket, tix, ticketType)}
